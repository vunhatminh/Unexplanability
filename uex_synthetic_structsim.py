...
def cycle6(start, role_start=0):
    """Builds a cycle-6  graph, with index of nodes starting at start
    and role_ids at role_start
    INPUT:
    -------------
    start       :    starting index for the shape
    ...
    OUTPUT:
    -------------
    graph       :    a cycle graph, with ids beginning at start
    roles       :    list of the roles of the nodes (indexed starting at
                     role_start)
    """
    graph = nx.Graph()
    ...
    roles = [role_start, role_start + 1, role_start + 2, role_start + 3, role_start + 4, role_start + 5]
    random.shuffle(roles)
    return graph, roles

def cycle6x(start, role_start=0):
    """Builds a cycle-6  graph, with index of nodes starting at start
    and role_ids at role_start
    INPUT:
    -------------
...
def star6(start, role_start=0):
    """Builds a star-6  graph, with index of nodes starting at start
    and role_ids at role_start
    INPUT:
    -------------
    start       :    starting index for the shape
...
def tree6(start, role_start=0):
    """Builds a tree-shape-6  graph, with index of nodes starting at start
    and role_ids at role_start
    INPUT:
    -------------
    start       :    starting index for the shape
